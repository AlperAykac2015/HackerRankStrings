  ...
  public static List<Person> getPeople() {
    return List.of(
        Person.builder()
            ...
            .profession(new Profession("Senior Developer", "Engineering", "TechCorp", 8, 85000,
        ...
        Person.builder()
            ...
            .profession(new Profession("Data Analyst", "Analytics", "FinancePlus", 12, 72000,
                EmploymentStatus.FULL_TIME))
            .skills(List.of(
        ...
        Person.builder()
            ...
            .profession(new Profession("UX Designer", "Design", "DesignHub", 4, 55000,
                EmploymentStatus.FULL_TIME))
            .skills(List.of(
        ...
        Person.builder()
            ...
            .profession(new Profession("Tech Lead", "Engineering", "TechCorp", 14, 105000,
                EmploymentStatus.FULL_TIME))
            .skills(List.of(
                new Skill("Java", ProficiencyLevel.EXPERT, "Programming"),
        ...
        Person.builder()
            ...
            .profession(
                new Profession("Freelance Consultant", "Consulting", "Self-Employed", 6, 78000,
        ...
        Person.builder()
            ...
            .profession(new Profession("Programme Manager", "Digital Services", "HMRC", 20, 92000,
                EmploymentStatus.FULL_TIME))
            .skills(List.of(
        ...
        Person.builder()
            ...
            .profession(new Profession("Junior Developer", "Engineering", "TechCorp", 2, 38000,
                EmploymentStatus.FULL_TIME))
            .skills(List.of(
        ...
        Person.builder()
            ...
            .profession(new Profession("VP of Analytics", "Analytics", "FinancePlus", 18, 130000,
                EmploymentStatus.FULL_TIME))
            .skills(List.of(
                new Skill("Python", ProficiencyLevel.EXPERT, "Programming"),
        ...
        Person.builder()
            ...
            .profession(new Profession("QA Engineer", "Engineering", "TechCorp", 1, 34000,
        ...
        Person.builder()
            ...
            .profession(new Profession("Product Manager", "Product", "DesignHub", 7, 88000,
                EmploymentStatus.FULL_TIME))
            .skills(List.of(
        ...
        Person.builder()
            ...
            .profession(new Profession("DevOps Engineer", "Engineering", "TechCorp", 10, 95000,
                EmploymentStatus.FULL_TIME))
            .skills(List.of(
                new Skill("Kubernetes", ProficiencyLevel.EXPERT, "DevOps"),
