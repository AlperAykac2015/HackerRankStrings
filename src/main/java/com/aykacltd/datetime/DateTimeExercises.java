...
import com.aykacltd.stream.Person;
import com.aykacltd.stream.SampleData;
...
public class DateTimeExercises {
  ...
  static void instantToZonedDateTime() {
    ...
    System.out.println("4.4 Same Instant in different zones:");
  ...
  static void durationToUnits() {
    ...
    System.out.println("6.4 Duration: 90061 seconds");
  ...
  static void compareZonedDateTimesAcrossZones() {
    ...
    System.out.println("9.2 London 3pm vs Tokyo 3pm:");
  ...
  static void convertBetweenZones() {
    ...
    System.out.println("10.2 London 2pm BST →");
  ...
  static void withZoneSameInstantVsSameLocal() {
    ...
    System.out.println("10.3 London 2pm BST:");
  ...
  static void internationalDateLine() {
    ...
    System.out.println("11.3 International Date Line:");
  ...
  static void dstSpringForwardGap() {
    ...
    System.out.println("12.1 DST Spring Forward Gap:");
  ...
  static void dstFallBackOverlap() {
    ...
    System.out.println("12.2 DST Fall Back Overlap:");
    System.out.println("    01:30 on 2025-10-26 exists TWICE:");
  ...
  static void durationAcrossDstBoundary() {
    ...
    System.out.println("12.3 Across spring-forward (2025-03-29 → 30):");
  ...
  static void builtInAdjusters() {
    ...
    System.out.println("13.1 Built-in adjusters (from " + date + ", " + date.getDayOfWeek() + "):");
  ...
  static void chronoUnitBetween() {
    ...
    System.out.println("14.1 ChronoUnit.between (1990-03-15 to today):");
  ...
  static void truncation() {
    ...
    System.out.println("14.2 Truncation of " + ldt + ":");
  ...
  static void supportedUnits() {
    System.out.println("14.3 Supported units:");
  ...
  static void pitfallImmutability() {
    ...
    System.out.println("16.1 ⚠ PITFALL: Immutability");
  ...
  static void pitfallEqualsVsIsEqual() {
    ...
    System.out.println("16.2 ⚠ PITFALL: equals() vs isEqual()");
  ...
  static void pitfallMonthIndexing() {
    ...
    System.out.println("16.3 ⚠ PITFALL: Month indexing");
  ...
  static void pitfallParsingAmbiguity() {
    ...
    System.out.println("16.4 ⚠ PITFALL: Ambiguous parsing of '01/02/2025'");
  ...
  static void pitfallLocalDateTimeHasNoZone() {
    ...
    System.out.println("16.5 ⚠ PITFALL: LocalDateTime has no zone");
  ...
  static void pitfallDurationVsPeriod() {
    System.out.println("16.6 ⚠ PITFALL: Duration vs Period");
  ...
  static void pitfallDstArithmetic() {
    ...
    System.out.println("16.7 ⚠ PITFALL: DST arithmetic");
  ...
  static void pitfallEpochAssumptions() {
    ...
    System.out.println("16.8 ⚠ PITFALL: Epoch millis vs seconds");
  ...
  static void pitfallToStringFormats() {
    System.out.println("16.9 ⚠ PITFALL: toString() varies by type");
  ...
  static void pitfallYearOf() {
    System.out.println("16.10 ⚠ PITFALL: yyyy vs uuuu in strict parsing");
